...
class ModflowPrtprp(mfpackage.MFPackage):
    ...
    referencetime : double
        * referencetime (double) real value defining the time at which to
          release particles. This is comparable to MODPATH 7 referencetime
          option 1.
    nreleasepts : integer
    ...
    perioddata : releasesetting
        * releasesetting (keystring) specifies when to release particles within
          the stress period. Overrides package-level REFERENCETIME option,
          which applies to all stress periods. By default, RELEASESETTING
          configures particles for release at the beginning of the specified
          time steps. For time-offset releases, provide a FRACTION with another
          RELEASESETTING option.
            all : [keyword]
    ...
    dfn = [
           ...
           ["block options", "name drape", "type keyword", "reader urword",
            "optional true"],
           ["block options", "name referencetime", "type double precision",
            "reader urword", "optional true"],
    ...
    def __init__(self, model, loading_package=False, boundnames=None,
                 ...
                 istopzone=None, drape=None, referencetime=None,
        ...
        self.referencetime = self.build_mfdata("referencetime", referencetime)
