...
# FILE created on November 01, 2023 07:43:27 UTC
import os
...
class MFSimulation(mfsimbase.MFSimulationBase):
    ...
    def __init__(self, sim_name='sim', version='mf6',
                 ...
                 verbosity_level=1, write_headers=True, lazy_io=False,
                 continue_=None, nocheck=None, memory_print_option=None,
                 maxerrors=None, print_input=None):
